<template>
  <div class="map-wrapper">
    ...
    <Map v-if="entries" :isLandscape="isLandscape()" :entries="filteredEntries.length ? filteredEntries : entries" :userLatLng="userLatLng" :selectedEntryID="selectedEntryID" @marker-clicked="selectedEntryID = $event"></Map>
  </div>
</template>
