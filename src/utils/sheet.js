...
module.exports = (sheetID, documentID, categoryTitle, columns) => {
  let cachePath = `${__dirname}/../data/cache/${documentID}_${sheetID}_${columns.join(
    "-"
  )}.json`;
      ...
      axios
        ...
        .then((response) => {
          ...
          response.data.values.forEach((row, index) => {
            let outputRow = {};
            outputRow.id = `${categoryTitle}-${index}`;
            outputRow.category = categoryTitle;
